...
class MenuTableViewController: UITableViewController {
    ...
    var countryNames = ["Canada", "India"]
    var friendsName = ["Aman", "Roop"]
    var collegeName = ["Lambton", "Sheridan"]
    
    var sectionTitles = ["Countries", "Friends", "Educational Institute"]
    
    var data = [0: ["Canada", "India"],
                1: ["Aman", "Roop"],
                2:["Lambton", "Sheridan"] ]
